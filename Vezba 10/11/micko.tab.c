...
{
       0,    59,    59,    70,    72,    76,    84,    85,    90,   102,
      89,   118,   124,   126,   136,   135,   144,   146,   150,   157,
     179,   181,   185,   186,   187,   188,   192,   196,   206,   222,
     223,   244,   245,   251,   263,   268,   273,   276,   282,   281,
     301,   303,   315,   318,   324,   329,   323,   343,   353
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_LSBRACKED",
  "_RSBRACKED", "ONLY_IF", "$accept", "program", "global_list",
...
{
     -53,    18,    35,   -53,   -53,   -53,    35,   -53,    -6,   -53,
      45,    17,   -53,   -53,    46,    35,    48,    47,   -53,   -53,
      49,   -53,   -53,    35,    50,   -53,   -53,    22,     2,   -53,
       8,    52,    37,    25,   -53,   -53,   -53,   -53,   -53,   -53,
      54,   -53,   -53,   -53,    41,   -53,     1,    37,    11,   -53,
     -53,   -53,    37,     8,    29,    16,    51,    37,     8,    53,
      -4,   -53,    37,    33,    55,   -53,   -53,   -53,    34,   -53,
      56,    37,   -53,   -53,   -53,    57,    37,    58,   -53,    60,
      59,    37,    60,    16,   -53,    38,   -53,   -53
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    16,    10,    14,     0,    20,    17,     0,     0,    18,
       0,     0,     0,     0,    20,    15,    21,    22,    23,    24,
      42,    25,    36,    37,     0,    44,    32,     0,     0,    29,
      31,    34,     0,     0,     0,     0,     0,     0,     0,     0,
       0,    48,     0,     0,     0,    26,    43,    19,     0,    45,
       0,    40,    35,    30,    27,     0,     0,     0,    33,    41,
       0,     0,    47,     0,    39,     0,    46,    28
};
...
{
     -53,   -53,   -53,   -53,   -53,    61,   -53,   -53,    -2,   -53,
     -53,   -53,   -53,   -53,    30,   -52,   -53,   -53,   -47,     3,
...
static const yytype_int8 yydefgoto[] =
{
      ...
      22,    25,    23,    26,    28,    36,    37,    38,    48,    49,
      50,    51,    59,    80,    39,    40,    57,    77,    69,    41
};
...
{
      60,    11,    44,    66,    10,    63,    31,    72,    32,    33,
      68,   -38,    62,    16,    34,    35,    42,    43,     3,    58,
      31,    24,    32,    33,    79,    64,    61,    62,    34,    82,
      70,    86,    13,    31,    85,    32,    33,    29,     4,    52,
      30,    34,    65,    53,    46,    42,    43,    47,    74,    62,
      62,    76,    12,    87,    62,    18,    15,    27,    19,    55,
      56,    21,    45,    71,    54,    73,    67,     9,     0,    83,
      84,    81,     0,     0,    75,    78,    62
};

static const yytype_int8 yycheck[] =
{
      47,     7,    30,    55,     6,    52,     4,    11,     6,     7,
      57,    10,    16,    15,    12,    13,     8,     9,     0,    18,
       4,    23,     6,     7,    71,    53,    15,    16,    12,    76,
      58,    83,    15,     4,    81,     6,     7,    15,     3,    14,
      18,    12,    13,    18,     7,     8,     9,    10,    15,    16,
      16,    17,     7,    15,    16,     7,    10,     7,    11,     5,
      19,    12,    10,    10,    34,    62,    15,     6,    -1,    11,
      11,    14,    -1,    -1,    19,    19,    16
};
...
{
       0,    22,    23,     0,     3,    24,    25,    26,    29,    26,
      29,     7,     7,    15,    27,    10,    29,    30,     7,    11,
      28,    12,    31,    33,    29,    32,    34,     7,    35,    15,
      18,     4,     6,     7,    12,    13,    36,    37,    38,    45,
      46,    50,     8,     9,    41,    10,     7,    10,    39,    40,
      41,    42,    14,    18,    35,     5,    19,    47,    18,    43,
      39,    15,    16,    39,    41,    13,    36,    15,    39,    49,
      41,    10,    11,    40,    15,    19,    17,    48,    19,    39,
      44,    14,    39,    11,    11,    39,    36,    15
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    21,    22,    23,    23,    24,    25,    25,    27,    28,
      26,    29,    30,    30,    32,    31,    33,    33,    34,    34,
...
#line 158 "micko.y" /* yacc.c:1646  */
    {
      ...
      { 
        ...
        if(lookup_symbol(arr[i], VAR|PAR|GVAR) == -1)
             insert_symbol(arr[i], VAR, (yyvsp[-5].i), ++var_num, NO_ATR);
          else 
...
#line 207 "micko.y" /* yacc.c:1646  */
    {
      char arr[1][20];
      char *s = get_name((yyvsp[-4].i));
      sprintf(arr[0],"%s%s",(yyvsp[-6].s),s);
...
#line 252 "micko.y" /* yacc.c:1646  */
    {
      char arr[1][20];
      char *i = get_name((yyvsp[-1].i));

      sprintf(arr[0],"%s%s",(yyvsp[-3].s),i);

      (yyval.i) = lookup_symbol(arr[0], (VAR|PAR|GVAR));
      
      if((yyval.i) == -1)
        err("'%s%s' undeclared", (yyvsp[-3].s),i);
    }
