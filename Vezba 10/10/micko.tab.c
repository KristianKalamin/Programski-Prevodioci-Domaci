...
{
       0,    63,    63,    74,    77,    76,    86,    87,    91,   102,
     104,   108,   116,   117,   122,   134,   121,   150,   156,   158,
     168,   167,   176,   178,   182,   189,   212,   214,   218,   219,
     220,   221,   225,   229,   239,   258,   259,   280,   281,   287,
     292,   294,   306,   309,   315,   314,   334,   336,   348,   351,
     357,   362,   356,   376,   386
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_STRUCT",
  "_TYPEDEF", "_DOT", "_STRUCT_ID", "ONLY_IF", "$accept", "program",
  "struct_list", "$@1", "str_variable_list", "str_variable", "global_list",
  "global_var", "function_list", "function", "$@2", "$@3", "type",
...
{
     -66,    15,   -10,   -66,    11,    33,    25,   -66,   -66,    33,
     -66,    47,   -66,   -66,    48,     3,    44,   -66,   -66,    49,
      33,    33,     0,   -66,    50,    51,    52,    45,   -66,    46,
     -66,   -66,   -66,   -66,    53,   -66,   -66,    -1,    55,    57,
     -66,   -66,    54,    56,    27,   -66,   -66,    58,    42,    -6,
     -66,   -66,   -66,   -66,   -66,   -66,    61,   -66,   -66,    -3,
     -66,   -66,    42,    -4,   -66,   -66,   -66,    42,    60,    31,
      41,    42,    63,    62,     8,   -66,    42,     6,    59,   -66,
     -66,     9,   -66,   -66,    42,   -66,   -66,   -66,    42,    42,
      64,    65,    66,    26,    65,    41,   -66,   -66,   -66
};
...
{
       3,     0,     9,     1,     0,     0,     0,    17,    10,     2,
      12,     0,     4,    13,     0,    14,     0,    14,    11,     0,
       0,    18,     0,     6,     0,     0,     0,     0,     7,     0,
      19,    15,     5,     8,     0,    22,    16,    20,     0,     0,
      26,    23,     0,     0,     0,    25,    24,     0,     0,     0,
      26,    21,    27,    28,    29,    30,    48,    31,    50,    38,
      42,    43,     0,     0,    35,    37,    39,     0,     0,     0,
       0,     0,     0,     0,     0,    54,     0,     0,     0,    32,
      49,     0,    51,    41,    46,    40,    36,    33,     0,     0,
       0,    47,     0,     0,    53,     0,    45,    34,    52
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -66,   -66,   -66,   -66,   -66,    67,   -66,   -66,   -66,    69,
     -66,   -66,    -5,   -66,   -66,   -66,   -66,   -66,    24,   -65,
     -66,   -66,   -61,     4,   -66,   -66,   -66,   -66,   -66,   -66,
     -66,   -66,   -66,   -66
};
...
{
      -1,     1,     2,    16,    22,    23,     5,     8,     9,    10,
      19,    34,    24,    26,    36,    40,    37,    41,    44,    52,
      53,    54,    63,    64,    65,    66,    73,    92,    55,    56,
      71,    90,    82,    57
};
...
{
      11,    74,     7,     7,    14,    80,    77,   -44,    67,     4,
      81,    75,    76,    27,    68,     3,    25,    72,    18,    85,
      38,    87,    76,    91,    76,    76,    89,    93,    94,     6,
      98,    47,    39,    48,    49,    47,     7,    48,    49,    50,
      51,    97,    76,    50,    79,    47,    12,    48,    49,    59,
      60,    61,    62,    50,    15,    17,    20,    29,    30,    21,
      32,    33,    42,    31,    43,    35,    70,    78,    58,    45,
      83,    46,    84,    88,    69,    95,     0,    96,    13,     0,
      86,    76,     0,     0,     0,     0,     0,     0,     0,    28
};

static const yytype_int8 yycheck[] =
{
       5,    62,     3,     3,     9,    70,    67,    10,    14,    19,
      71,    15,    16,    13,    20,     0,    21,    20,    15,    11,
      21,    15,    16,    84,    16,    16,    17,    88,    89,    18,
      95,     4,    37,     6,     7,     4,     3,     6,     7,    12,
      13,    15,    16,    12,    13,     4,    21,     6,     7,     7,
       8,     9,    10,    12,     7,     7,    12,     7,     7,    10,
      15,    15,     7,    11,     7,    12,     5,     7,    10,    15,
       7,    15,    10,    14,    50,    11,    -1,    11,     9,    -1,
      76,    16,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    22
};
...
{
       0,    24,    25,     0,    19,    29,    18,     3,    30,    31,
      32,    35,    21,    32,    35,     7,    26,     7,    15,    33,
      12,    10,    27,    28,    35,    35,    36,    13,    28,     7,
       7,    11,    15,    15,    34,    12,    37,    39,    21,    35,
      38,    40,     7,     7,    41,    15,    15,     4,     6,     7,
      12,    13,    42,    43,    44,    51,    52,    56,    10,     7,
       8,     9,    10,    45,    46,    47,    48,    14,    20,    41,
       5,    53,    20,    49,    45,    15,    16,    45,     7,    13,
      42,    45,    55,     7,    10,    11,    46,    15,    14,    17,
      54,    45,    50,    45,    45,    11,    11,    15,    42
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    23,    24,    25,    26,    25,    27,    27,    28,    29,
      29,    30,    31,    31,    33,    34,    32,    35,    36,    36,
      38,    37,    39,    39,    40,    40,    41,    41,    42,    42,
...
#line 77 "micko.y" /* yacc.c:1646  */
    {
      ++structCount;
      insert_symbol((yyvsp[0].s), STR, 3/*STRUCT*/, NO_ATR, structCount );
    }
...
#line 92 "micko.y" /* yacc.c:1646  */
    {
      int idx = lookup_symbol((yyvsp[-1].s), STR);
      idx = get_atr2(idx);
      if(idx != structCount)
        insert_symbol((yyvsp[-1].s), STR, (yyvsp[-2].i), NO_ATR, structCount);
      else
...
#line 190 "micko.y" /* yacc.c:1646  */
    {
        int idx = lookup_symbol((yyvsp[-2].s), STR);
        int str = get_atr2(idx);
        int i = 1;
        if(idx != -1)
        {
            char *s[10];
            while(get_atr2(idx+i) == str)
            {
              char *n = get_name(idx+i);
              int t = get_type(idx+i);
              s[i-1] = (char*)malloc(20*sizeof(char));
              sprintf(s[i-1],"%s.%s",(yyvsp[-1].s),n);
              insert_symbol(s[i-1], VAR, t, ++var_num, NO_ATR);
              i++;
            }             
        }
        else 
           err("'%s' struct not declared", (yyvsp[-1].s)); 
      }
...
#line 240 "micko.y" /* yacc.c:1646  */
    {
        char s[20];
        sprintf(s,"%s.%s",(yyvsp[-5].s),(yyvsp[-3].s));
        int idx = lookup_symbol(s, VAR);
        if(idx == -1)
          err("invalid lvalue '%s' in assignment", (yyvsp[-5].s));
        else
        {
          int idx = lookup_symbol((yyvsp[-3].s), STR);
          if(get_type(idx) != get_type((yyvsp[-1].i)))
            err("incompatible types in assignment");
        }
