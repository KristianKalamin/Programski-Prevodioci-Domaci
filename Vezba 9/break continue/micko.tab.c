...
{
       0,    65,    65,    76,    78,    82,    90,    91,    96,   108,
      95,   124,   130,   132,   142,   141,   150,   152,   156,   165,
     167,   171,   172,   173,   174,   175,   176,   177,   182,   188,
     191,   192,   181,   200,   210,   221,   231,   235,   248,   249,
     270,   271,   277,   282,   287,   290,   296,   295,   315,   317,
     329,   332,   338,   343,   337,   357
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_WHILE", "_BREAK", "_CONTINUE",
  "_AROP", "_RELOP", "ONLY_IF", "$accept", "program", "global_list",
  "global_var", "function_list", "function", "$@1", "$@2", "type",
  "parameter", "body", "$@3", "variable_list", "variable",
  "statement_list", "statement", "while_statement", "$@4", "$@5", "$@6",
  "$@7", "break_statement", "continue_statement", "rel_exp",
  "compound_statement", "assignment_statement", "num_exp", "exp",
  "literal", "function_call", "$@8", "argument", "if_statement", "if_part",
  "@9", "$@10", "return_statement", YY_NULLPTR
};
#endif
...
{
     -60,     9,     8,   -60,   -60,   -60,     8,   -60,    15,   -60,
      25,   -11,   -60,   -60,     6,     8,    29,    30,   -60,   -60,
      28,   -60,   -60,     8,    35,   -60,   -60,    31,     1,   -60,
      34,    53,    36,   -60,   -60,   -60,    37,    39,   -60,   -60,
     -60,   -60,   -60,   -60,   -60,    46,   -60,   -60,    45,   -60,
     -60,    53,    -9,   -60,   -60,   -60,    53,    21,    54,   -60,
     -60,    41,    53,    55,     4,   -60,    53,    16,   -60,    53,
     -60,   -60,    10,    53,   -60,   -60,   -60,   -60,    56,    53,
      47,    57,    58,    41,    47,   -60,   -60,   -60,    59,   -60,
      41,    60,   -60
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    16,    10,    14,     0,    19,    17,     0,     0,    18,
       0,     0,     0,    19,    15,    28,     0,     0,    20,    25,
      27,    26,    21,    22,    23,    50,    24,    52,    41,    44,
      45,     0,     0,    38,    40,    42,     0,     0,     0,    33,
      34,     0,     0,     0,     0,    55,     0,     0,    36,     0,
      51,    53,     0,    48,    43,    39,    37,    29,     0,     0,
      49,     0,     0,     0,    35,    47,    30,    54,     0,    19,
      31,     0,    32
};
...
{
     -60,   -60,   -60,   -60,   -60,    64,   -60,   -60,    -3,   -60,
     -60,   -60,   -60,   -60,   -33,   -59,   -60,   -60,   -60,   -60,
     -60,   -60,   -60,     3,   -60,   -60,   -30,    11,   -60,   -60,
...
static const yytype_int8 yydefgoto[] =
{
      ...
      22,    25,    23,    26,    28,    38,    39,    58,    82,    88,
      91,    40,    41,    71,    42,    43,    72,    53,    54,    55,
      63,    81,    44,    45,    62,    78,    46
};
...
{
      57,    52,    70,    10,    13,    30,    65,    31,    32,     3,
      66,     4,    16,    33,    34,    74,    15,    35,    36,    37,
      24,    64,    11,    66,    87,    30,    67,    31,    32,    66,
      79,    76,    12,    33,    68,    66,    18,    35,    36,    37,
      21,    19,    27,    80,    47,    30,    29,    31,    32,    84,
      56,    61,    59,    33,    60,   -46,    90,    35,    36,    37,
      48,    49,    50,    51,    69,    73,    66,    83,    85,    86,
       9,    89,    77,    92,     0,     0,     0,    75
};

static const yytype_int8 yycheck[] =
{
      33,    31,    61,     6,    15,     4,    15,     6,     7,     0,
      19,     3,    15,    12,    13,    11,    10,    16,    17,    18,
      23,    51,     7,    19,    83,     4,    56,     6,     7,    19,
      20,    15,     7,    12,    13,    19,     7,    16,    17,    18,
      12,    11,     7,    73,    10,     4,    15,     6,     7,    79,
      14,     5,    15,    12,    15,    10,    89,    16,    17,    18,
       7,     8,     9,    10,    10,    10,    19,    11,    11,    11,
       6,    12,    69,    13,    -1,    -1,    -1,    66
};
...
{
       0,    23,    24,     0,     3,    25,    26,    27,    30,    27,
      30,     7,     7,    15,    28,    10,    30,    31,     7,    11,
      29,    12,    32,    34,    30,    33,    35,     7,    36,    15,
       4,     6,     7,    12,    13,    16,    17,    18,    37,    38,
      43,    44,    46,    47,    54,    55,    58,    10,     7,     8,
       9,    10,    48,    49,    50,    51,    14,    36,    39,    15,
      15,     5,    56,    52,    48,    15,    19,    48,    13,    10,
      37,    45,    48,    10,    11,    49,    15,    45,    57,    20,
      48,    53,    40,    11,    48,    11,    11,    37,    41,    12,
      36,    42,    13
};
...
{
       0,    22,    23,    24,    24,    25,    26,    26,    28,    29,
      27,    30,    31,    31,    33,    32,    34,    34,    35,    36,
      36,    37,    37,    37,    37,    37,    37,    37,    39,    40,
      41,    42,    38,    43,    44,    45,    46,    47,    48,    48,
      49,    49,    49,    49,    50,    50,    52,    51,    53,    53,
      54,    54,    56,    57,    55,    58
};
...
#line 1325 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 188 "micko.y" /* yacc.c:1646  */
    {
      code("\n\t\t\t%s\t@while_false%d", get_jump_stmt((yyvsp[0].i), TRUE), whileCount);
    }
...
#line 192 "micko.y" /* yacc.c:1646  */
    {
        code("\n\t\t\tJMP\t\t@while%d", whileCount);
        gen_snlab("while_false", whileCount);
    }
...
#line 195 "micko.y" /* yacc.c:1646  */
    {breakOK = FALSE; continueOK = FALSE; }
...
#line 201 "micko.y" /* yacc.c:1646  */
    {
      if(breakOK != TRUE)
        err("ERROR 'break' must be in while loop");

      code("\n\t\t\tJMP\t\t@while_false%d", whileCount);
    }
...
#line 211 "micko.y" /* yacc.c:1646  */
    {
      if(continueOK != TRUE)
        err("ERROR 'continue' must be in while loop");
